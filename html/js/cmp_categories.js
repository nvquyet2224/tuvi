...
(function () {
    ...
    const handleCheckboxes = () => {
        ...
        const toggleDeleteButton = () => {
            if (elements.deleteFilter) elements.deleteFilter.classList.toggle("hide", checkedData.size === 0);
        };
        ...
        if (elements.deleteFilter) elements.deleteFilter.addEventListener("click", resetFilters);
